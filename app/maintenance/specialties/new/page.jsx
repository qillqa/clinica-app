...
import { createSpecialty } from "@/services/maintenance/specialties";

export default function SpecialtiesNewPage() {
    ...
    const [specialty, setSpecialty] = useState(initialState)
    ...
    const handleSave = async () => {
        ...
        toast.success('Se guardo la especialidad correctamente.')
        ...
        <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-12">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Registro de especialidades de la clinica</p>
                </div>
